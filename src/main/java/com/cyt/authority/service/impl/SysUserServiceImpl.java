...
import com.cyt.authority.dao.SysUserMapper;
import com.cyt.authority.dao.SysUserRoleMapper;
...
import com.cyt.authority.utils.DateTimeUtils;
import com.cyt.authority.utils.PoiUtils;
...
public class SysUserServiceImpl  implements SysUserService {
	...
	@Override
	public SysUser createByName(String name) {
		SysUser sysUser = sysUserMapper.findByName(name);
		return sysUser;
	}
	@Override
